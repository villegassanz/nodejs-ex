...
*/
    var nuevoMensaje = new Modelo_Mensaje({
          id_bus: data.id_autobus, //en esta parte recibimos del arreglo data los valores que ingreso el usuario
          rfc: data.rfc,
          ruta: data.ruta,
          ejemplo: data.eje,
          fecha: new Date()
...
server.listen(8080, function() {  
  console.log("Servidor corriendo en http://nodejs-proyectov10.44fs.preview.openshiftapps.com:8080");
});